...
//        
//        public static Argument<IComparable<T>> FromExpressionComparable<T>(Expression<Func<T>> expression)
//        {
//            Func<T> func = expression.Compile();
//            T value = func();
//
...
//            }
//
//            return new Argument<IComparable<T>>((IComparable<T>)value, name);
//        }
//    }
//}
